...
**Not a new demo — a name for the pattern you watched six times. Every guardrail was a decision made once, in code or a markdown file, not a prompt you hope the model obeys.**
