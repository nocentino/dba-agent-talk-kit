...
echo "== 0/6 Clear any stale cert files (makes this script re-runnable) =="
...
echo "== 1/6 Master keys + certificates on both instances =="
sql1 "
...
echo "== 2/6 Exchange certificate public keys =="
...
echo "== 3/6 Cross-register login + certificate for endpoint auth =="
sql1 "
...
echo "== 4/6 HADR endpoints on 5022 =="
...
echo "== 5/6 Create AG on primary (automatic seeding) =="
sql1 "
...
echo "== 6/6 Join secondary + allow seeding =="
sql2 "
