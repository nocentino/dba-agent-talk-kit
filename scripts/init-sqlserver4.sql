-- =====================================================================
-- SqlServer4 — DBA monitoring login ("deadlocks & tempdb" fleet member)
-- Mirrors the dba_monitor account on SqlServer1/2/3.
-- =====================================================================
...
PRINT 'dba_monitor account ready on sqlserver4.';
GO
